...
| 文書 | 種別 | 内容 | 行数 | Ver |
|---|:--:|---|---:|---|
| `doc_modernization_todo.md` | C | ドキュメント最新化 TODO。**①〜⑧ は完了、§10 に未完 1 件が残る**（スクリーンショット 10 枚） | 488 | 2.5 |
...
| # | タスク | 内容 | 状態 |
|---|---|---|---|
| 1 | スクリーンショット 10 枚 | `doc_modernization_todo.md` §10 の残タスク #1。`ANTHROPIC_API_KEY` のある環境で撮影（Qdrant が要る `D-05`〜`D-08` は 2026-09-26 に撮影済み） | ⏳ 環境 |
