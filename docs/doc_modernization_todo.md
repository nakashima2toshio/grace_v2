...
| # | 内容 | 状態 |
|---|---|---|
| 1 | ~~スクリーンショット 14 枚（`S-03`〜`S-05` / `R-03`〜`R-06` / `C-01` / `D-03` / `D-05`〜`D-08` / `T-01`）~~ | ✅ **完了**（2026-09-26・14 枚すべて撮影し README へ掲載。全 31 枚が揃った。撮影時の条件は README「撮影の進捗」の注記） |
...
| Version | 内容 |
|---|---|
| 2.5 | 残タスク #1（スクリーンショット 14 枚）を完了へ（2026-09-26）。`ANTHROPIC_API_KEY` と Qdrant（Linux バイナリ）を用意して実画面を撮り、README のコメントを外した |
