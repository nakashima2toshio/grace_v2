...
**Version 2.5** | 作成日: 2026-09-12 | 最終更新: 2026-09-26 | 対象コミット: `d832a54`（master）
...
> **残っているのは「API キーが要る」スクリーンショット 10 枚と、
...
| # | 内容 | 状態 |
|---|---|---|
| 1 | スクリーンショット 10 枚（`S-03`〜`S-05` / `R-03`〜`R-06` / `C-01` / `D-03` / `T-01`） | ⏳ `ANTHROPIC_API_KEY` のある環境で撮影（`D-05`〜`D-08` の 4 枚は 2026-09-26 に撮影済み） |
