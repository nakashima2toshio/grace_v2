...
> **参考ドキュメント**
> - [`grace/docs/grace_core_flow.md`](./grace_core_flow.md) — 5 段階設計・8 コアモジュール・プロンプト/API 発行部・`agent_example.py` 解説
> - [`grace/docs/grace_core.md`](./grace_core.md) — コアモジュール群の横断アーキテクチャ（IPO リンク集）
