...
5. [クラス・関数 IPO詳細](#4-クラス関数-ipo詳細)
   - [使用例](#41-使用例)
     - [基本的なワークフロー](#411-基本的なワークフロー)
     - [コールバック付きの使用](#412-コールバック付きの使用)
     - [ジェネレータ版の使用](#413-ジェネレータ版の使用)
   - [ExecutionState データクラス](#42-executionstate-データクラス)
   - [Executor クラス](#43-executor-クラス)
   - [ファクトリ関数](#44-ファクトリ関数)
6. [設定・定数](#5-設定定数)
