...
- 一覧は §6.4「画面ショット一覧」を参照（**全 30 枚**）

### 撮影の進捗

| 状態 | 枚数 | スロット |
|---|---:|---|
| ✅ **撮影済み・掲載中** | 16 | `B-01` / `S-01` / `S-02` / `S-06a` / `S-06b` / `H-01` / `H-02a` / `H-02b` / `R-01` / `R-02` / `D-01` / `D-02` / `D-04` / `D-09` / `E-01` / `E-02` |
...
本文中のコメントアウトを外す。**全 30 枚**（`S-06a`/`S-06b` と `H-02a`/`H-02b` は 2 枚 1 組）。
