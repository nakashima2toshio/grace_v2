...
| ⬜ 未撮影（コメントのまま） | 24 | `H-01` / `H-02a` / `H-02b` / `S-03`〜`S-05` / `R-01`〜`R-06` / `C-01` / `D-01`〜`D-08` / `T-01` / `E-01` / `E-02` |
...
本文中のコメントアウトを外す。**全 29 枚**（`S-06a`/`S-06b` と `H-02a`/`H-02b` は 2 枚 1 組）。
